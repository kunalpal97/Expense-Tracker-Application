...
export default function DashboardLayout() {
  ...
  const handleLogout = () => {
    // Use AuthContext logout so React state updates too
    logout();

    // Optional: remove any other keys your app might use
    if (localStorage.getItem("user")) localStorage.removeItem("user");

    // Navigate to login and replace history entry
    navigate("/login", { replace: true });

    // No hard reload required — ProtectedRoute will react to isAuthenticated change.
    // If you *still* see stale UI in some edge case, uncomment next line:
